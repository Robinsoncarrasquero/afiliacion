<x-guest-layout>
    <div class="px-5 py-5 p-lg-0 bg-surface-secondary">
        <div class="d-flex justify-content-center">
            <div class="col-lg-5 col-xl-4 p-12 p-xl-20 position-fixed start-0 top-0 h-screen overflow-y-hidden bbg-primary bg-success d-none d-lg-flex flex-column">
                <!-- Logo -->
                ...
                <div class="mt-32 mb-20">
                    <h1 class="ls-tight font-bolder display-6 text-white mb-5">
                        Entrada al sitio web.
                    </h1>
                    <p class="text-white-80">
                        Acceso solo para afiliados registrado en el sitio web.
                    </p>
                </div>
                <!-- Circle -->
                <div class="w-56 h-56 bbg-orange-500 rounded-circle position-absolute bottom-0 end-20 transform translate-y-1/3"></div>
            </div>
            <div class="col-12 col-md-9 col-lg-7 offset-lg-5 border-left-lg min-h-lg-screen d-flex flex-column justify-content-center py-lg-16 px-lg-20 position-relative">
                <div class="row">
                    <div class="col-lg-10 col-md-9 col-xl-6 mx-auto ms-xl-0">
                            ...
                            <div class="mb-5">
                                <div class="d-flex align-items-center justify-content-between">
                                    ...
                                    <div class="mb-2">
                                        ...
                                        <a href="{{ route('password.request') }}" class="small text-muted">Olvido el password?</a>
                                        @endif
                                    </div>
                                </div>
                        ...
                        <div class="my-6">
                            <small>{{ __('No tengo una cuenta de usuario') }}</small>
